...
urlpatterns = [
    ...
    path('task-update/<int:pk>/',
         UpdateTaskView.as_view(), name='task-update'),
    path('task-delete/<int:pk>/',
         DeleteTaskView.as_view(), name='task-delete'),
    path('category-create/',
         CreateCategoryView.as_view(), name='category-create'),
    path('category-update/<int:pk>/',
         UpdateCategoryView.as_view(), name='category-update'),
    path('category-delete/<int:pk>/',
         DeleteCategoryView.as_view(), name='category-delete'),
]
